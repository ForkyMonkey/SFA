...
class TextToBinWidget(QtWidgets.QWidget):
    ...
    def show_dialog_help(self):
        text = "Программа предназначена для зашифрования и расшифрования текста в соответствии с <b>ГОСТ 34.12 - 2015" \
               "</b> и <b>ГОСТ 34.12 - 2018</b>. Для выбора режима работы блочного шифра перейдите в раздел \"Правка" \
               "\" - \"Режим работы\". <p>Перед началом зашифрования и расшифрования убедитесь в правильности ввода " \
               "ключа (256 бит) и параметров режимов работы алгоритмов блочного шифрования.</p>"
        dialog = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Information, "Справка", "<p>" + text,
